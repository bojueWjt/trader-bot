module.exports = {
  apps: [{
    ...
    env: {
      ...
      SIGNAL_IMPORTER_MODULE: process.env.SIGNAL_IMPORTER_MODULE || 'freqtrade.signal_strategy.importer',
      ...
      HERMES_TRADER_CRON_ENABLED: process.env.HERMES_TRADER_CRON_ENABLED || '1',
