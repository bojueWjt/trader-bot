module.exports = {
  apps: [{
    ...
    env: {
      ...
      TRADER_TRADING_DB_PATH: process.env.TRADER_TRADING_DB_PATH || '',
      WATCHER_TRADING_DB: process.env.WATCHER_TRADING_DB || '',
      TRADING_DB_PATH: process.env.TRADING_DB_PATH || '',
      ...
      PRICE_MONITOR_ENABLED: process.env.PRICE_MONITOR_ENABLED || '0',
