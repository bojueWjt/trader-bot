...
MAXMEMORY_BYTES="${REDIS_MAXMEMORY_BYTES:-1610612736}"
CGROUP_LIMIT_BYTES=""
REDIS_CPU_LIMIT=""
REDIS_NANO_CPUS=""
REDIS_PIDS_LIMIT=""
...
STREAM_MAX_BYTES="${REDIS_STREAM_MAX_BYTES:-268435456}"
TOTAL_STREAM_MAX_BYTES="${REDIS_TOTAL_STREAM_MAX_BYTES:-1073741824}"
