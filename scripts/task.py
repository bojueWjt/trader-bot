...
def cmd_unclaim(a):
    _rmw(lambda d: (_set_task(d, a.module, a.task, "todo"), _touch(a.module, d)))
    print(f"ok: 释放 {a.task}")
...
def main():
    ...
    s = sub.add_parser("unclaim"); s.add_argument("module", choices=MODULES); s.add_argument("task"); s.set_defaults(f=cmd_unclaim)
